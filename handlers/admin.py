...
from .sqlit import info_members, reg_one_channel, reg_channels,del_one_channel,user_partners,info_partners,delit_partners,obnovatrafika,cheak_traf,info_chyornaya_vdova,info_filmyshd,info_films_online_everyday
import asyncio
